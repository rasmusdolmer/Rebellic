...
namespace Rebellic
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void CheckBox_Checked(object sender, RoutedEventArgs e)
        {
            ...
            totalPris += 249;
            BookingTotalPris.Text = totalPris.ToString();
        }
        ...
        private void BookingVidere(object sender, TappedRoutedEventArgs e)
        {
            ...
            switch (getName)
            {
                ...
                case "videreTilBekræftT":
                    ...
                    AngivKontaktOplysninger.Visibility = Visibility.Collapsed;
                    AngiveTlfNr.Text = GivneMobilNr.Text;
                    BookingProcessArrow3.Visibility = Visibility.Visible;
                    BookingProcessKontakt.Text = KontaktNavn.Text;
                    break;
                ...
                case "VidereTilKontaktOplTekst":
                    if (kontaktTlfValidate == 0 && KontaktTlf.Text.Length > 0)
                    {
                        ...
                        KontaktFødselsdag.MaxYear = DateTime.Today.AddYears(-6);
                        KontaktFødselsdag.Date = DateTime.Today.AddYears(-6);
                        if (GivneMobilNr.Text == "28694800")
                        {
                            ...
                            KontaktFødselsdag.Date = Convert.ToDateTime("07/16/1998 00:00:00.00");
                        }
                    }
                    break;
            }
        ...
        private void selectDate_DateChanged(object sender, DatePickerValueChangedEventArgs e)
        {
            ...
            if (LedigeTiderPåValgteDato.Count > 1)
            {
                ...
                selectTid2.Children.Clear();
                selectTid3.Children.Clear();
                ...
                IngenLedigeTider.Visibility = Visibility.Collapsed;
            }
            else
            {
                selectTid.Children.Clear();
                selectTid2.Children.Clear();
                selectTid3.Children.Clear();
                IngenLedigeTider.Visibility = Visibility.Visible;
            }
